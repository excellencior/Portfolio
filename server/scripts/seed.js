...
const projects = [
	...
	{ id: 13, title: "Ray Tracing", category: "Foundations", date: "September 14", subtitle: "Computer Graphics", description: "Implemented ray-tracing functionality for objects, modeling how light reflects and refracts across different surfaces and how light-source position, luminance, color, and type affect the rendered scene.", image_url: "/images/computer-graphics-raytracing-14.webp", repo_link: "https://github.com/excellencior/CSE-410-Computer-Graphics-Sessional", deployed_at: "", tags: ["C++", "Bitmap"], sort_order: 10 },
	{ id: 3, title: "Catch the Egg - 2D Physics Game", category: "Foundations", date: "November, 2021", subtitle: "Real-Time Interactive 2D Game in C++ & OpenGL [BUET L1/T1]", description: "A 2D arcade physics game implemented in modern C++ using OpenGL (iGraphics). Features customized velocity vectors, airflow turbulence simulation, sound synthesis, texture rasterization, and frame-rate independent rendering.", image_url: "https://github.com/excellencior/Catch-the-Egg/blob/master/Catch_the_egg_Project_SS/combined.png?raw=true", repo_link: "https://github.com/excellencior/Catch-the-Egg/tree/master", deployed_at: "", tags: ["C++", "OpenGL", "Game Physics", "Computer Graphics"], sort_order: 11 },
